...
export default async function NewBuyRequestPage({
  ...
  if (!searchParams.cardCode) {
    return (
      <div>
        <h1 className="text-2xl font-semibold text-slate-50">Create buy request</h1>
        <p className="mt-1 text-sm text-slate-400">
          Pick the card you want to buy from the catalog.
        </p>
  ...
  return (
    <div className="max-w-xl">
      ...
      <BuyRequestForm cardCode={card.cardCode} />
    </div>
  );
}
